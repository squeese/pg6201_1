        ...
        <Options.Wrapper>
          ...
          <Options.Dictionary name="material">
            ...
            <Options.Event onChange={({ state:material }) => {
              if (!material.hasOwnProperty('ambient')) return; // argh, called once before dismounting
                ...
                {list.map(index => (
                  <Options.Dictionary key={index} name={index}>
                    ...
                    <Options.Event onChange={({ state:light }) => {
                      if (!light.hasOwnProperty('ambient')) return; // argh, called once before dismounting
